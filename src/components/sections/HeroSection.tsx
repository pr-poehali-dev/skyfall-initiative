    ...
    <section className="min-h-screen flex flex-col items-center justify-center px-6 pt-24 pb-20 relative">
      ...
      <div className="relative z-10 text-center max-w-3xl mx-auto">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-zinc-900/80 border border-zinc-800 mb-8">
          ...
          <span className="text-sm text-zinc-400">Одобрение за 5 минут онлайн</span>
        </div>

        {/* Headline - customize your value proposition */}
        <h1 className="font-display text-5xl md:text-7xl font-bold tracking-tight mb-6">
          <span className="text-zinc-100 block">Банковские продукты.</span>
        ...
        <p className="text-lg md:text-xl text-zinc-500 max-w-2xl mx-auto mb-10 leading-relaxed text-balance">
          Подбираем выгодные кредиты, карты и вклады от ведущих банков. Онлайн-заявка за 2 минуты, решение за 5 минут. Помогаем оформить без походов в отделение.
        </p>

        {/* CTAs */}
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a href="#pricing">
            <LiquidCtaButton>Подобрать продукт</LiquidCtaButton>
          </a>
          <a
            href="#features"
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col items-start">
              ...
              <p className="text-sm text-zinc-500">
                Оформили продукты <span className="text-zinc-300 font-medium">50 000+</span> клиентов
              </p>
            </div>
          </div>
        </div>
